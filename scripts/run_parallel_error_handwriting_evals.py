#!/usr/bin/env python3
"""Run full error-handwriting evaluations concurrently on selected GPUs."""
...
from run_error_handwriting_eval import (
    RESULTS_DIR,
    TARGET_SAMPLE_COUNT,
...
def main() -> int:
    ...
    runner = Path(__file__).with_name("run_error_handwriting_eval.py")
